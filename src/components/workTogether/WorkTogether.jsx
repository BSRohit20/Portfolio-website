    ...
    <div className="py-25 max-w-169 mx-auto px-2">
      <div className="text-center">
        <p className="text-white md:font-semibold text-2xl sm:text-3xl md:text-5xl pb-8">
          Have an AI/ML or Full-Stack Project? Let's discuss your project!
        </p>
        <p className="text-[#A5ACB5] text-xs sm:text-lg font-normal text-center pb-8">
          I'm always open to discussing innovative AI/ML projects, full-stack development 
          opportunities, and research collaborations. Let's connect and build intelligent solutions together.
        </p>
        <a
          href="#contact"
