...
const addressData = [
  ...
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "rohitbs2004@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+91 6383816114",
  },
  {
    icon: faGithub,
    title: "GitHub",
    description: "github.com/BSRohit20",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I'm available for freelance work and collaboration opportunities. 
                Drop me a line if you have an AI/ML or full-stack project you think I'd be a good fit for.
              </p>
            </div>
